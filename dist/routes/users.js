...
router.get('/', auth_1.verifyToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.pool.query('SELECT id, firstName, lastName FROM users')];
            case 1:
                result = _a.sent();
...
router.get('/:id', auth_1.verifyToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.pool.query('SELECT id, firstName, lastName FROM users WHERE id = $1', [id])];
            case 2:
                result = _a.sent();
...
router.post('/', auth_1.verifyToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName, password, hashedPassword, result, err_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, db_1.pool.query('INSERT INTO users (firstName, lastName, password) VALUES ($1, $2, $3) RETURNING *', [firstName, lastName, hashedPassword])];
            case 3:
                result = _b.sent();
